...
export const AboutUsView: React.FC<AboutUsViewProps> = ({ onNavigate }) => {
  return (
    <main className="w-full">
      {/* 1. Atmospheric Hero Section with Innovation Hub Imagery & Problem Statement - Pixel-Accurate to about_us(1).html */}
      <section className="relative w-full overflow-hidden bg-slate-950 py-20 lg:py-28 text-white min-h-[660px] flex items-center justify-center">
        ...
        <div className="relative z-10 max-w-5xl mx-auto px-4 sm:px-6 lg:px-8 text-center flex flex-col items-center">
          ...
          {/* Hero Headline */}
          <h1 className="font-extrabold text-4xl sm:text-5xl lg:text-6xl text-white tracking-tight leading-[1.15] max-w-4xl">
          ...
          {/* Verbatim Problem Statement Card */}
      ...
      {/* 3. Expected Solution Section: 3 Lifecycle Pillars */}
                ...
                <div className="flex items-center justify-between pb-5 border-b border-slate-100 mb-6">
                  <div className="flex items-center gap-3">
                    ...
                    <div>
                      ...
                      <h3 className="font-bold text-xl text-slate-900">Skill Development</h3>
                    </div>
                  </div>
                </div>
                ...
                <div className="flex items-center justify-between pb-5 border-b border-slate-100 mb-6">
                  <div className="flex items-center gap-3">
                    ...
                    <div>
                      ...
                      <h3 className="font-bold text-xl text-slate-900">Internship</h3>
                    </div>
                  </div>
                </div>
                <ul className="space-y-4 text-sm text-slate-600 leading-relaxed">
                ...
                <div className="flex items-center justify-between pb-5 border-b border-slate-100 mb-6">
                  <div className="flex items-center gap-3">
                    ...
                    <div>
                      ...
                      <h3 className="font-bold text-xl text-slate-900">Placement</h3>
                    </div>
                  </div>
                </div>
                <ul className="space-y-4 text-sm text-slate-600 leading-relaxed">
      ...
      {/* 4. Overall Platform Features Section */}
      <section className="py-20 bg-white border-b border-slate-200">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="rounded-2xl bg-gradient-to-r from-slate-900 via-slate-900 to-blue-950 p-8 sm:p-12 text-white shadow-xl relative overflow-hidden">
            <div className="absolute -right-10 -bottom-10 w-80 h-80 bg-blue-600/20 rounded-full blur-3xl pointer-events-none"></div>
            <div className="relative z-10">
              <div className="inline-flex items-center gap-2 px-3 py-1 rounded-md bg-blue-500/20 border border-blue-400/30 text-xs font-semibold text-blue-300 uppercase tracking-wider mb-4">
                <span className="material-symbols-outlined text-[16px]">security</span>
                System Architecture &amp; Governance
              </div>
              <h3 className="font-extrabold text-2xl sm:text-3xl lg:text-4xl text-white tracking-tight max-w-3xl">
                Overall Platform Features
              </h3>
              <p className="mt-3 text-slate-300 text-base max-w-2xl leading-relaxed">
                Enterprise-grade governance, unified security, and synchronous multi-stakeholder integration underpinning the entire national ecosystem.
              </p>
              <div className="mt-10 grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
                <div className="bg-white/10 backdrop-blur-md rounded-xl p-5 border border-white/15">
                  ...
                  <h4 className="text-base font-semibold text-white">Role-Based Access</h4>
                  <p className="mt-2 text-xs text-slate-300 leading-relaxed">
                    Role-based access for students, academicians, industries, and institutions with custom permission levels and specialized portal environments.
                  </p>
                </div>
                <div className="bg-white/10 backdrop-blur-md rounded-xl p-5 border border-white/15">
                  ...
                  <h4 className="text-base font-semibold text-white">Secure Document Management</h4>
                  <p className="mt-2 text-xs text-slate-300 leading-relaxed">
                    Secure document management for resumes, certificates, internship reports, and academic records with tamper-proof validation.
                  </p>
                </div>
                <div className="bg-white/10 backdrop-blur-md rounded-xl p-5 border border-white/15">
                  ...
                  <h4 className="text-base font-semibold text-white">Collaboration Features</h4>
                  <p className="mt-2 text-xs text-slate-300 leading-relaxed">
                    Collaboration features for industry mentorship, live projects, workshops, and research partnerships between academic and industry peers.
                  </p>
                </div>
                <div className="bg-white/10 backdrop-blur-md rounded-xl p-5 border border-white/15">
                  ...
                  <h4 className="text-base font-semibold text-white">Ecosystem Integration</h4>
                  <p className="mt-2 text-xs text-slate-300 leading-relaxed">
                    Integration with learning platforms, certification providers, and institutional databases for automatic synchrony and credit mapping.
                  </p>
                </div>
                <div className="bg-white/10 backdrop-blur-md rounded-xl p-5 border border-white/15 md:col-span-2 lg:col-span-2">
                  ...
                  <h4 className="text-base font-semibold text-white">Comprehensive Analytics</h4>
                  <p className="mt-2 text-xs text-slate-300 leading-relaxed">
                    Comprehensive analytics to support data-driven decisions for institutions, industries, and policymakers, tracking demand trends, skill preparedness, and national impact metrics.
                  </p>
                </div>
              </div>
            </div>
      ...
      {/* 5. Role-Based CTA: Choose Your Bridge Lane */}
        ...
        <div className="relative z-10 max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
            ...
            <button
              ...
              className="text-left group p-6 rounded-xl bg-slate-800/80 border border-slate-700 hover:border-blue-500 hover:bg-slate-800 transition-all flex flex-col justify-between cursor-pointer"
            >
              <div>
                ...
                <h3 className="font-bold text-lg text-white group-hover:text-blue-400 transition-colors">I am a Student</h3>
                <p className="mt-2 text-xs text-slate-300 leading-relaxed">
              ...
              <div className="mt-6 flex items-center justify-between text-xs font-bold text-blue-400 pt-4 border-t border-slate-700/60 w-full">
            ...
            >
              <div>
                ...
                <h3 className="font-bold text-lg text-white group-hover:text-sky-400 transition-colors">I am an Institution</h3>
                <p className="mt-2 text-xs text-slate-300 leading-relaxed">
                  Harmonize your department's course syllabus with live job markets, manage placement metrics, and integrate with APAAR.
                </p>
              </div>
              <div className="mt-6 flex items-center justify-between text-xs font-bold text-sky-400 pt-4 border-t border-slate-700/60 w-full">
            ...
            >
              <div>
                ...
                <h3 className="font-bold text-lg text-white group-hover:text-indigo-400 transition-colors">I am an Industry Leader</h3>
                <p className="mt-2 text-xs text-slate-300 leading-relaxed">
                  Syndicate real-world technical problems, sponsor apprenticeships, and hire pre-evaluated, project-ready graduates.
                </p>
              </div>
              <div className="mt-6 flex items-center justify-between text-xs font-bold text-indigo-400 pt-4 border-t border-slate-700/60 w-full">
